...
# Populate the crime type tables for Seattle and New York
...
seattle_crime_type.to_csv('seattle_crime_type_from2020.csv', index=False)
newyork_crime_type.to_csv('newyork_crime_type_from2020.csv', index=False)
